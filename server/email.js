...
const sendWelcomeEmail = async ({ email, username, accountNumber, accountType, currencySymbol, verificationToken }) => {
    ...
    <body>
      <div class="email-container">
        ...
        <p style="text-align: center;">
          <a class="button" href="https://trustlinebank.chainaccess.org/auth/verify-email?token=${verificationToken}">
            Verify Your Email
          </a>
        </p>
        <div class="footer">
          Contact support at <a href="mailto:trustline@chainaccess.org">trustline@chainaccess.org</a>
        </div>
      </div>
    </body>
    </html>
  ...
  await resend.emails.send({
    from: 'TrustLine Digital Bank <trustlinedigital@chainaccess.org>',
    to: [email],
