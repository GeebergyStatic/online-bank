...
function SignUp(props) {
   ...
   * @returns 
   */
  const isSignupValid = ({ firstName, lastName, email, password, confirmPassword, country }) => {
        ...
        {currentSection === 3 && (
          <>
            <div className="text-center mb-3">
              <p className="gradient-text fw-bold">Set a 4-digit Account PIN</p>
              <div className="d-flex justify-content-center gap-2 mb-2 text-white">
                {[...Array(4)].map((_, i) => (
                  <span
                    key={i}
            ...
            <div className="d-flex text-center justify-content-center">
              <button className="btn btn-primary mx-auto" style={{ maxWidth: '60%' }} onClick={signup}>
                Sign Up
              </button>
            </div>
          </>
